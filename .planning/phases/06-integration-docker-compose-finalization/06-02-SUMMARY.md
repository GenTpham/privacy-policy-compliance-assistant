...
Docker build verification (`docker compose build`) and live `make smoke-test` require Docker to be running — these are deferred to human checkpoint approval.
...
- VERIFICATION.md: exists, contains mâu thuẫn, docker compose ps, qdrant_storage, Steps 5/7/8
