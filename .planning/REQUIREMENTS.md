...
- [ ] **EVAL-01**: User (admin) can run a full experiment on the validation dataset and see context_hit / answer_match / retrieved metrics in Phoenix
- [ ] **EVAL-02**: System documents root cause analysis of context_hit metric and retrieval quality findings
